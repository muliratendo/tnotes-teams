...
type UserQuery struct {
	...
	withCreatedBoards        *BoardQuery
	withCreatedCards         *CardQuery
...
func (uq *UserQuery) QueryCreatedWorkspaces() *WorkspaceQuery {
...
// QueryCreatedBoards chains the current query on the "created_boards" edge.
func (uq *UserQuery) QueryCreatedBoards() *BoardQuery {
...
// QueryCreatedCards chains the current query on the "created_cards" edge.
func (uq *UserQuery) QueryCreatedCards() *CardQuery {
...
func (uq *UserQuery) QueryQuickNotes() *QuickNoteQuery {
	query := (&QuickNoteClient{config: uq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := uq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (uq *UserQuery) QueryWorkspaceMemberships() *WorkspaceMemberQuery {
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withCreatedWorkspaces:    uq.withCreatedWorkspaces.Clone(),
		withCreatedBoards:        uq.withCreatedBoards.Clone(),
		withCreatedCards:         uq.withCreatedCards.Clone(),
		withComments:             uq.withComments.Clone(),
		withQuickNotes:           uq.withQuickNotes.Clone(),
		withActivityLogs:         uq.withActivityLogs.Clone(),
		withWorkspaces:           uq.withWorkspaces.Clone(),
		withWorkspaceMemberships: uq.withWorkspaceMemberships.Clone(),
...
func (uq *UserQuery) WithCreatedWorkspaces(opts ...func(*WorkspaceQuery)) *UserQuery {
	query := (&WorkspaceClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withCreatedWorkspaces = query
	return uq
}

// WithCreatedBoards tells the query-builder to eager-load the nodes that are connected to
// the "created_boards" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithCreatedBoards(opts ...func(*BoardQuery)) *UserQuery {
	query := (&BoardClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withCreatedBoards = query
	return uq
}

// WithCreatedCards tells the query-builder to eager-load the nodes that are connected to
// the "created_cards" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithCreatedCards(opts ...func(*CardQuery)) *UserQuery {
	query := (&CardClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withCreatedCards = query
	return uq
}
...
func (uq *UserQuery) WithQuickNotes(opts ...func(*QuickNoteQuery)) *UserQuery {
	query := (&QuickNoteClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withQuickNotes = query
	return uq
}
...
func (uq *UserQuery) WithWorkspaceMemberships(opts ...func(*WorkspaceMemberQuery)) *UserQuery {
	query := (&WorkspaceMemberClient{config: uq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	uq.withWorkspaceMemberships = query
	return uq
}
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	var (
		...
		_spec       = uq.querySpec()
		loadedTypes = [8]bool{
			uq.withCreatedWorkspaces != nil,
			uq.withCreatedBoards != nil,
			uq.withCreatedCards != nil,
			uq.withComments != nil,
			uq.withQuickNotes != nil,
			uq.withActivityLogs != nil,
			uq.withWorkspaces != nil,
			uq.withWorkspaceMemberships != nil,
		}
	)
	...
	if query := uq.withCreatedWorkspaces; query != nil {
		if err := uq.loadCreatedWorkspaces(ctx, query, nodes,
	...
	if query := uq.withCreatedBoards; query != nil {
		if err := uq.loadCreatedBoards(ctx, query, nodes,
			func(n *User) { n.Edges.CreatedBoards = []*Board{} },
			func(n *User, e *Board) { n.Edges.CreatedBoards = append(n.Edges.CreatedBoards, e) }); err != nil {
			return nil, err
		}
	}
	if query := uq.withCreatedCards; query != nil {
		if err := uq.loadCreatedCards(ctx, query, nodes,
			func(n *User) { n.Edges.CreatedCards = []*Card{} },
			func(n *User, e *Card) { n.Edges.CreatedCards = append(n.Edges.CreatedCards, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := uq.withQuickNotes; query != nil {
		if err := uq.loadQuickNotes(ctx, query, nodes,
			func(n *User) { n.Edges.QuickNotes = []*QuickNote{} },
			func(n *User, e *QuickNote) { n.Edges.QuickNotes = append(n.Edges.QuickNotes, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := uq.withWorkspaceMemberships; query != nil {
		if err := uq.loadWorkspaceMemberships(ctx, query, nodes,
...
func (uq *UserQuery) loadCreatedWorkspaces(ctx context.Context, query *WorkspaceQuery, nodes []*User, init func(*User), assign func(*User, *Workspace)) error {
...
func (uq *UserQuery) loadCreatedBoards(ctx context.Context, query *BoardQuery, nodes []*User, init func(*User), assign func(*User, *Board)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(board.FieldCreatedBy)
	}
	query.Where(predicate.Board(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.CreatedBoardsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (uq *UserQuery) loadCreatedCards(ctx context.Context, query *CardQuery, nodes []*User, init func(*User), assign func(*User, *Card)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(card.FieldCreatedBy)
	}
	query.Where(predicate.Card(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.CreatedCardsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (uq *UserQuery) loadQuickNotes(ctx context.Context, query *QuickNoteQuery, nodes []*User, init func(*User), assign func(*User, *QuickNote)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(quicknote.FieldCreatedBy)
	}
	query.Where(predicate.QuickNote(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.QuickNotesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (uq *UserQuery) loadWorkspaceMemberships(ctx context.Context, query *WorkspaceMemberQuery, nodes []*User, init func(*User), assign func(*User, *WorkspaceMember)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
