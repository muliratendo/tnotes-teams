...
func (cq *CommentQuery) QueryCard() *CardQuery {
...
func (cq *CommentQuery) WithCard(opts ...func(*CardQuery)) *CommentQuery {
	query := (&CardClient{config: cq.config}).Query()
...
func (cq *CommentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Comment, error) {
	...
	if query := cq.withCard; query != nil {
		if err := cq.loadCard(ctx, query, nodes, nil,
			func(n *Comment, e *Card) { n.Edges.Card = e }); err != nil {
			return nil, err
		}
	}
...
func (cq *CommentQuery) loadCard(ctx context.Context, query *CardQuery, nodes []*Comment, init func(*Comment), assign func(*Comment, *Card)) error {
...
func (cq *CommentQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := cq.ctx.Fields; len(fields) > 0 {
		...
		if cq.withCard != nil {
			_spec.Node.AddColumnOnce(comment.FieldCardID)
		}
		if cq.withUser != nil {
